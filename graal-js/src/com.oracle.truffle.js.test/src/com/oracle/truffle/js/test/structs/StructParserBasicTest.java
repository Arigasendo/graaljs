...
/**
 * Basic tests for struct parser functionality.
 */
public class StructParserBasicTest {

    @BeforeClass
    public static void setUpClass() {
        // Set staging environment for all tests
        System.setProperty("test.environment", "staging");
        System.setProperty("js.test.environment", "staging");
    }


    @Test
    public void testValidStructDeclaration() {
    ...
    @Test
    public void testStructUnreserved() {
        try (Context ctx = JSTest.newContextBuilder().option(ECMASCRIPT_VERSION_NAME, ECMASCRIPT_VERSION_STAGING).build()) {
            org.graalvm.polyglot.Source validSource = org.graalvm.polyglot.Source.newBuilder("js", """
            'use strict';
            var struct = 1;
    ...
    @Test
    public void testStructDerivedSuperCall() {
        try (Context ctx = JSTest.newContextBuilder().option(ECMASCRIPT_VERSION_NAME, ECMASCRIPT_VERSION_STAGING).build()) {
            org.graalvm.polyglot.Source source = org.graalvm.polyglot.Source.newBuilder("js", """
            struct A {
                constructor() {
